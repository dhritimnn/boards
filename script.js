...
const AppState = {
    quotes: [
        "Grind in silence. Results make noise.",
    "There will be days when motivation disappears—those are the days discipline decides your future.",
    "Comfort kills progress.",
    "Every focused hour today removes years of regret tomorrow.",
    "Discipline over everything.",
    "The grind hurts, but quitting hurts longer.",
    "Start tired. Finish strong.",
    "You don’t need to feel confident to work; confidence is built by working despite doubt.",
    "Focus. Work. Repeat.",
    "Your future is shaped by what you do on ordinary days.",
    "Pressure builds strength.",
    "Most people fail not because they lack ability, but because they quit when the grind becomes lonely.",
    "Earn your confidence.",
    "Small actions, repeated daily, change entire lives.",
    "Pain is temporary. Skill is permanent.",
    "Growth feels uncomfortable because your old limits are breaking.",
    "Show up daily.",
    "Discipline is choosing what you want most over what you want now.",
    "Be consistent, not lucky.",
    "Every late night and early morning is a quiet investment in a louder future.",
    "Average is a decision.",
    "The work you avoid today becomes the obstacle tomorrow.",
    "Dreams demand effort.",
    "You don’t rise by wishing—you rise by working.",
    "Hard days are not signs to stop—they are tests of commitment.",
    "Work before you feel ready.",
    "Talent opens doors; grind keeps them open.",
    "Sacrifices feel heavy now, but regret weighs much more later.",
    "Growth lives in discomfort.",
    "Stop waiting for the perfect moment and master the present one.",
    "One day, your discipline will thank you for the life it created.",
    "No excuses. Just execution.",
    "Struggle means you’re upgrading yourself.",
    "Consistency doesn’t look impressive in the moment, but it builds unstoppable momentum.",
    "Dreams don’t care about your mood—they respond only to effort.",
    "Hard work isn’t glamorous, but it’s always effective.",
    "Work until discipline becomes habit and habit becomes identity.",
    "You don’t become strong by avoiding struggle, but by facing it daily.",
    "Show up tired. Leave proud.",
    "Every sacrifice is a step closer to freedom.",
    "The path is difficult because it leads somewhere meaningful.",
    "Focus is built when distractions are ignored repeatedly.",
    "One focused day can change everything.",
    "The version of you that keeps going will always defeat the version that quits.",
    "Ordinary days create extraordinary lives.",
    "Stop measuring progress by feelings; measure it by actions taken.",
    "Hunger creates legends.",
    "Your future self is watching—don’t disappoint them.",
    "Today’s grind is tomorrow’s freedom.",
